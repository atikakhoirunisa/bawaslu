            ...
            <div class="row form-group">
              ...
              <div class="col col-md-9">
                <div class="form-check">
                 @if($data_pengawasan->bentuk == "Langsung")
                 <label for="bentuk">
                  <input type="radio" name="bentuk" value="Langsung" id="bentuk" checked="checked"> Langsung
                  <input type="radio" name="bentuk" value="Tidak Langsung" id="bentuk"> Tidak Langsung
                </label>
              </div>
              @elseif($data_pengawasan->bentuk == "Tidak Langsung")
              <label for="bentuk">
                <input type="radio" name="bentuk" value="Langsung" id="bentuk"> Langsung
                <input type="radio" name="bentuk" value="Tidak Langsung" id="bentuk" checked="checked"> Tidak Langsung
              </label>
              @endif
            </div>
          </div>
            ...
            <div class="col col-md-9">
              <div class="form-check">
                ...
                <label for="dugaan_pelanggaran">
                  <input type="radio" name="dugaan_pelanggaran" value="Ada" id="dugaan_pelanggaran" checked="checked"> Ada
              ...
              <label for="dugaan_pelanggaran">
                ...
                <input type="radio" name="dugaan_pelanggaran" value="Tidak Ada" id="dugaan_pelanggaran" checked="checked"> Tidak Ada
              </label>
              @endif
            </div>
          </div>
